...
typedef struct{
	...
	uint8_t					Trigger_Case;	/*specifies either rising, falling or both as trigger
	...
	void (*P_IRQ_CallBack)(void);			//sets the C function which will be called when IRQ happen
...
/**************************************************************************************/
// APIs supports "MCAL EXTI Driver"
//********************************
